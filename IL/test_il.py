...
def test():
    ...
    model_path = os.path.join(current_dir, "il_model.pth")
    ...
    env = football_env.create_environment(env_name='11_vs_11_stochastic', representation='simple115v2', render=True)
